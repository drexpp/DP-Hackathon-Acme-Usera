...
<td> <jstl:out value="${examPaper.moment}"></jstl:out>   </td>
</tr>
...
<display:table name="examQuestions" id="row" requestURI="examPaper/display.do" class="displaytag">
	...
	<security:authorize access="hasRole('STUDENT')">
		...
		<display:column>
			<a href="examAnswer/student/create.do?examPaperId=${row.exam.examPaper.id}"> <spring:message code="examAnswer.create"/></a>
		</display:column>
	</security:authorize>
